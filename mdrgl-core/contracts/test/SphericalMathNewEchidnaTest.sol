...
contract SphericalMathNewEchidnaTest {
    uint256 constant Q96 = 2**96;
    
    function test_sqrt_zero() public pure {
        uint256 result = SphericalMathNew.sqrt(0);
        assert(result == 0);
    }
    ...
    function test_sqrt_monotonicity(uint256 x, uint256 y) public pure {
        ...
        uint256 sqrtX = SphericalMathNew.sqrt(x);
        uint256 sqrtY = SphericalMathNew.sqrt(y);
    ...
    function test_sqrt_perfect_squares(uint256 n) public pure {
        ...
        uint256 result = SphericalMathNew.sqrt(input);
    ...
    function test_sqrt_Q96_identity() public pure {
        uint256 result = SphericalMathNew.sqrt(Q96);
        assert(result == Q96);
    }
    ...
    function test_orthogonal_equal_reserves(uint256 reserve, uint256 numAssets) public pure {
        ...
        uint256 result = SphericalMathNew.computeOrthogonalComponent(
            sumSquaresQ96,
            sumReservesQ96,
            numAssets
        );
    ...
    function test_price_ratio_equal_reserves() public pure {
        ...
        uint256 ratio = SphericalMathNew.calculatePriceRatio(reserve, reserve, radius);
        assert(ratio == Q96);
    }
    ...
    function test_price_ratio_inverse_relationship(uint256 reserveI, uint256 reserveJ, uint256 radius) public pure {
        ...
        uint256 ratioIJ = SphericalMathNew.calculatePriceRatio(reserveI, reserveJ, radius);
        uint256 ratioJI = SphericalMathNew.calculatePriceRatio(reserveJ, reserveI, radius);
    ...
    function test_price_ratio_bounds(uint256 reserveI, uint256 reserveJ, uint256 radius) public pure {
        ...
        uint256 ratio = SphericalMathNew.calculatePriceRatio(reserveI, reserveJ, radius);
        assert(ratio > 0);
    ...
    function test_price_ratio_monotonicity(uint256 reserveBase, uint256 reserve1, uint256 reserve2, uint256 radius) public pure {
        ...
        uint256 ratio1 = SphericalMathNew.calculatePriceRatio(reserveBase, reserve1, radius);
        uint256 ratio2 = SphericalMathNew.calculatePriceRatio(reserveBase, reserve2, radius);
    ...
    function test_update_sums_no_change() public pure {
        ...
        (uint256 newSumReserves, uint256 newSumSquares) = SphericalMathNew.updateSumsAfterTrade(
            sumReservesQ96,
            sumSquaresQ96,
            reserve,
            reserve,  // same value
    ...
    function test_update_sums_conservation(
        ...
        (uint256 newSumReserves, ) = SphericalMathNew.updateSumsAfterTrade(
            sumReservesQ96,
            sumSquaresQ96,
            oldIQ96,
            newIQ96,
    ...
    function test_update_sums_squares_positive(
        ...
        (, uint256 newSumSquares) = SphericalMathNew.updateSumsAfterTrade(
            sumReservesQ96,
            sumSquaresQ96,
            oldIQ96,
            newIQ96,
    ...
    function test_update_sums_zero_handling() public pure {
        ...
        (uint256 newSumReserves1, uint256 newSumSquares1) = SphericalMathNew.updateSumsAfterTrade(
            sumReservesQ96,
            sumSquaresQ96,
            0,
            50 * Q96,
        ...
        (uint256 newSumReserves2, uint256 newSumSquares2) = SphericalMathNew.updateSumsAfterTrade(
            200 * Q96,
            20000 * Q96,
            50 * Q96,
            0,
    ...
    function test_validate_constraint_perfect_sphere() public pure {
        ...
        (bool valid, ) = SphericalMathNew.validateConstraintFromSums(
            sumReservesQ96,
            sumSquaresQ96,
            radiusQ96,
            numAssets,
    ...
    function test_validate_constraint_deviation_calculation(
        ...
        (bool valid, uint256 deviation) = SphericalMathNew.validateConstraintFromSums(
            sumReservesQ96,
            sumSquaresQ96,
            radiusQ96,
            numAssets,
    ...
    function test_pool_constants_valid_ranges(
        ...
        uint256 sqrtNumAssetsQ96 = SphericalMathNew.sqrt(numAssets * Q96);
