...
library SphericalMath {
    ...
    /// @notice Validates sphere constraint using sum-tracking for O(1) complexity (with PoolConstants)
    ...
    /// @param constants Pool constants structure
    ...
    function validateConstraintFromSums(
        ...
        return validateConstraintFromSums(
            sumReservesQ96,
            sumSquaresQ96,
            constants.radiusQ96,
            constants.numAssets,
            constants.sqrtNumAssetsQ96,
            constants.epsilonQ96
        );
    }
